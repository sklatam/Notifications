...
{
    public class UpdatePreferenciasPortal : OM.Common.Data.RunnerBase<SqlProvider>
    {
        ...
        {
            var command = this.Database.GetStoredProcCommand("prc_UpdatePreferenciasPortal");
